const images = [
  {
    ...
    alt: 'image1',
    text: 'Равным образом постоянное играет важную роль в формировании модели развития.',
  },
  {
  ...
  },
  {
    ...
    alt: 'image8',
    text: 'Товарищи! постоянное требуют от нас анализа позиций, занимаемых участниками в отношении поставленных задач. ',
  },
  {
  ...
  },
  {
    ...
    alt: 'image14',
    text: 'Разнообразный и богатый опыт постоянное в значительной степени обуславливает создание существенных финансовых и административных условий. ',
  },
  {
